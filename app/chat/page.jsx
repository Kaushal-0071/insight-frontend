            ...
            {messages.length === 0 ? (
              <div className="h-full flex flex-col items-center justify-center text-center px-4">
                ...
                <p className="text-muted-foreground max-w-md mb-8">
                  Ask anything to get started. Try asking about code, markdown, or general questions.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 max-w-lg w-full">
                  {["Tell me about markdown", "What can you help me with?", "Hello Gemini!"].map((suggestion) => (
                    <button
                      key={suggestion}
